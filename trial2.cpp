...
double LengthConverter()
	...
	//open file
      ...
      string inunit,outunit,choice;
	  
      int LoopLimit,LoopIterator;
	  
      cout<<"Enter how many times you wan to run length converter: \n";
     ...
     myfile<<outunit<<endl;
      ...
      if(inunit == "f")
      {
          ...
          else if(outunit == "c")
        {
			 y = (x - 32.0) * (5.0/9.0);
            cout<<y<<" Celsius"<<endl;
             myfile<<y<<" Celsius"<<endl;
        }
        
         else if(outunit == "f")
        {
			y = x;
			cout<<y<<" Fahrenheit"<<endl;
             myfile<<y<<" Fahrenheit"<<endl;
        }
